...
지원하고자 하는 프로그램을 추린 후에는 다시 한 번 해당 학교 홈페이지들을 쭉 훑으며 미리 몇 가지를 정리해 두는 것이 좋습니다. 봐야 하는 학교가 너무 많아서 나중엔 하나도 기억이 안 나고 다시 들어가서 확인하는 데 시간도 많이 들어가더라구요 😢 
...
CV 작성 관련해서는 워낙 좋은 자료들이 많아, 같은 내용은 반복할 필요가 없을 것 같아요. 그 외 준비하며 느꼈던 소소한 부분을 정리해 보았습니다.
...
#### 석사 어드미션은 공장식이라는 걸 기억하자

욕심 많고 소심한 제가 만족스러운 지원 패키지 대신 행복을 택한 것은 석사 어드미션이 빡세지 않다는 확신이 있었기 때문입니다. 두 가지 이유에서 이렇게 생각했습니다.
...
무엇보다 현실적으로 퇴근 후 시간을 내기가 참 어려웠습니다. 일하기도 바쁘고 야근이 없는 것도 아닌데, 언제 그렇게 빡세게 지원자료를 만들 수 있을지 막막했습니다. 지원하는 동안 자기계발과 개발 공부를 멈출 수도 없었구요. 그래서 다시 한 번, **저는 어플라이에 너무 진을 빼지 않기로 결심했습니다**.

대신 잠, 소중한 사람들과의 시간, 개인 공부에 좀 더 시간을 쓰기로 마음 먹었습니다. 어플라이 자료를 준비하면서 욕심 부리지 않았고, 각 영역에서 어느 정도 점수를 딸 수 있겠다 싶으면 더 고치지 않았습니다. 이것 때문에 붙을 수 있을 거라고 생각했던 학교들에 줄줄이 떨어졌나 싶기도 하지만, 어쨌든 가장 오고 싶었던 학교에 붙었으니 괜찮은 전략이었다고 생각하려 합니다.
